...
* It's pretty tiny; it's built with "Sinatra":http://sinatrarb.com and "Prototype":http://prototypejs.org
* Auto-linking: pasting an image displays it inline, youtube videos will appear as well
...
<code>http/chat.rb -e production</code>
...
Hugely scalable nanite clusters with redundancy and ridiculous uptime, and an uplink to the Millennium Falcon.
